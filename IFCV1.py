...
def uaku():
	try:
		ua=open('gen.txt','r').read().splitlines()
		for ub in ua:
			ugen.append(ub)
	except:
		a=requests.get('https://github.com/IKFAR-IFC/f/blob/main/gen.txt').text
		ua=open('gen.txt','w')
...
def menu(my_name,my_id):
	...
	cetak(nel('\tHaii Pengguna Bernama [green]%s[white] Tolol'%(my_name)))
	...
	print(f'{N}├───[{asu}✓{N}]{H} Status   {N}: \033[41m\033[1;37m PERTALIT MAHAL \x1b[0m\x1b[1;97m{N}')
	...
	print(f'{N}├───[{h}6{N}] Bot Menu  ')
	print(f'{N}├───[{h}7{N}] Crack Dari Gmail ')
...
def bot_menu():
	print(f'{N}├───────────────────────────────────────────────────────')
	print(f'{N}├───[{H}1{N}] BOT SHARE POSTINGAN FB')
	print(f'{N}├───[{H}2{N}] BOT SPAM WA')
	print(f'{N}├───[{H}3{N}] BOT SPAM SMS')
	print(f'{N}├──╭[{h}PILIH MENU{N}]────────────────────────────────────────────')
	hc = input(f'│  ╰─➣{h} ')
	if hc in ['1','01']:
		token_cokkie()
	elif hc in ['2','02']:
...
def token_cookie():
	...
	idt = input("Masukan link Postingan : ")
	...
	try:
		...
		for x in range(limit):
			...
			if 'id' in post:
				print(f" {n}. {h}[IKFAR-IFC]{N} berhasil membagikan {data['id']}")
			else:
...
def spam_wa():
	global nomor
	print(f"\n     {h}├─── {P}Contoh {h}: {K}+628389921xxxx")
	time.sleep(0.5)
	nomor = input(f"     {h}├─── {P} Nomer Target  {h}: {P}").replace("+62","")
	print(f" {P}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
	time.sleep(2.1)
	time.sleep(1)
	if nomor == "":
...
class sxp_wa:
	...
	def main(self):
		...
		self.wa_otp_5(nomor)
		self.wa_otp_6(nomor)
		print(f" {P}[{H}✓{P}] {P} [IFC] Berhasil Spam Wa")
...
class sxp_sms:
	...
	def main(self):
		...
		print(f" {P}[{H}✓{P}] {P} [IFC] Berhasil  Spam Sms")
#-------------[ CRACK-FROM-FILE ]------------------#
def crack_file():
...
def mail_goblok():
	x = 0
	print(f'{N}├───────────────────────────────────────────────────────')
	print(f'{N}├───[{H}1{N}] Dump Id Dari @gmail.com ')
	print(f'{N}├───[{H}2{N}] Dump Id Dari @yahoo.com ')
	print(f'{N}├───[{H}3{N}] Dump Id Dari @hotmail.com ')
	print(f'{N}├───[{H}4{N}] Dump Id Dari @outlook.com ')
	print(f'{N}├──╭[{h}PILIH Gmail{N}]────────────────────────────────────────────')
	hc = input(f'│  ╰─➣{h} ')
	print("├───MAAF MENU INI MASIH DALAM PERBAIKKAN ")
	back()
	if hc in["1"]:
		email = "@gmail.com"
		nama = input(f"├─── {N}Masukkan Nama : ")
		jumlah = int(input(f"├─── {N}Masukkan Limit : "))
		for z in range(jumlah):
			x +=1
			id.append(nama+str(x)+email+"|"+nama)
			sys.stdout.write(f"\r├─── {N}Proses Dump Id, Dump Succes {len(id)} id....");sys.stdout.flush()
	elif hc in["2"]:
		email = "@yahoo.com"
		nama = input(f"├─── {N}Masukkan Nama: ")
		jumlah = int(input(f"├─── {N}Masukkan Limit : "))
...
def setting():
	...
	print(f'{N}├───[{H}3{N}] Akun Random {H}[RECOMMEND]{N}')
	...
	print(f'{N}├───[{H}2{N}] Mbasic {k}[ERROR]{N}')
	print(f'{N}├───[{H}3{N}] Touch {k}[ERROR]{N} ')
	print(f'{N}├───[{H}4{N}] Mtouch {k}[ERROR]{N}')
